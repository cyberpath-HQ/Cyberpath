    ...
    return (
        <div className="flex flex-wrap items-center gap-2">
            ...
            <Button
                variant="outline"
                size="sm"
                onClick={() => window.open(shareLinks.linkedin, `_blank`, `noopener`)}
            >
                <svg className="mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Button
                variant="outline"
                size="sm"
                onClick={() => window.open(shareLinks.reddit, `_blank`, `noopener`)}
            >
                <svg className="mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Button
                variant="outline"
                size="sm"
                onClick={() => window.open(shareLinks.hackernews, `_blank`, `noopener`)}
            >
                <svg className="mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
